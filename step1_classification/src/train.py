...
def initialize_optimizer(optimizer_name, params_to_update, lr=None, weight_decay=None):
...
def train_model(model, dataloaders, criterion, optimizer,
                log, device, num_epochs=25, is_inception=False):
    since = time.time()
...
def train():
    ...
    data_dir = os.path.join("..", "..", "data", "8_class")
    ...
    optimizer_ft, lr, weight_decay = initialize_optimizer(
        optimizer_name, params_to_update, lr=1e-3)
    log.message_loging(
    ...
    model_ft, hist = train_model(model_ft, dataloaders_dict, criterion, optimizer_ft,
                                 log, device, num_epochs=num_epochs, is_inception=(model_name == "inception"))
